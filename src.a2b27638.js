...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/data_module.js":[function(require,module,exports) {
"use strict";
...
var _iterator = _createForOfIteratorHelper(_data_module.default),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var product = _step.value;
    cart[product.name] = _objectSpread(_objectSpread({}, product), {}, {
      count: 0
    });
...
function renderItem(_ref) {
  ...
  (0, _utils.addHtml)("\n    <p>\n      ".concat(name, " [ ").concat(price, " \u0440\u0443\u0431 ] - ").concat(count, " \u0448\u0442\n      <button class=\"addTocart\" data-name=\"").concat(name, "\" data-price=\"").concat(price, "\">\n        \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C\n      </button>\n      \n      <button class=\"deleteTocart\" data-name=\"").concat(name, "\" data-price=\"").concat(price, "\">\n        \u0423\u0434\u0430\u043B\u0438\u0442\u044C\n      </button>\n    </p>\n  "));
}
...
function renderPage() {
  ...
  var _iterator2 = _createForOfIteratorHelper(_data_module.default),
      _step2;
  ...
  (0, _utils.addHtml)("\u0418\u0442\u043E\u0433: ".concat(totalPrice, " \u0440\u0443\u0431")); // выбирает все кнопки по классу addTocart
  ...
  document.querySelectorAll(".deleteTocart").forEach(function (el) {
    // навешиваем им событие на "клик"
    el.addEventListener("click", function (event) {
      // ЭТА ФУНКЦИЯ ВЫЗЫВАЕТСЯ ТОЛЬКО ПРИ КЛИКЕ
      // достаем из атрибутов значение свойств
      ...
      if (cart[name].count > 0) {
        // уменьшаем итог
        totalPrice -= price; // уменьшаем количество в тележке

        cart[name].count -= 1; // перерисовываем страницу

        renderPage();
      } else if ("".concat(name) === 'Помидоры') {
        alert("\u041F\u043E\u043C\u0438\u0434\u043E\u0440\u043E\u0432 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 \u043D\u0435\u0442");
      } else if ("".concat(name) === 'Курица') {
        alert("\u041A\u0443\u0440\u0438\u0446\u044B \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 \u043D\u0435\u0442");
      } else if ("".concat(name) === 'Котлета') {
...
renderPage();
},{"./data_module":"src/data_module.js","./utils":"src/utils.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
